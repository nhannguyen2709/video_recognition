...
def TemporalSegmentNetworks_SpatialStream(input_shape, dropout_prob, classes, partial_bn=True):
    img_input_1 = Input(shape=input_shape)
    img_input_2 = Input(shape=input_shape)
    img_input_3 = Input(shape=input_shape)
    
    block1_conv1 = Conv2D(32, (3, 3), strides=(2, 2), use_bias=False, name='block1_conv1')
    ...
    block2_sepconv1 = SeparableConv2D(128, (3, 3), padding='same', use_bias=False, name='block2_sepconv1')
    ...
    block2_sepconv2 = SeparableConv2D(128, (3, 3), padding='same', use_bias=False, name='block2_sepconv2')
    block2_sepconv2_bn = BatchNormalization(name='block2_sepconv2_bn')
    block2_pool = MaxPooling2D((3, 3), strides=(2, 2), padding='same', name='block2_pool')
    ...
    block3_sepconv1 = SeparableConv2D(256, (3, 3), padding='same', use_bias=False, name='block3_sepconv1')
    ...
    block3_sepconv2 = SeparableConv2D(256, (3, 3), padding='same', use_bias=False, name='block3_sepconv2')
    block3_sepconv2_bn = BatchNormalization(name='block3_sepconv2_bn')
    block3_pool = MaxPooling2D((3, 3), strides=(2, 2), padding='same', name='block3_pool')
    ...
    block4_sepconv1 = SeparableConv2D(728, (3, 3), padding='same', use_bias=False, name='block4_sepconv1')
    ...
    block4_sepconv2 = SeparableConv2D(728, (3, 3), padding='same', use_bias=False, name='block4_sepconv2')
    block4_sepconv2_bn = BatchNormalization(name='block4_sepconv2_bn')
    block4_pool = MaxPooling2D((3, 3), strides=(2, 2), padding='same', name='block4_pool')
    ...
    for i in range(8):
        ...
        shared_2 = SeparableConv2D(728, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv1')
        x_1 = shared_2(x_1)
        x_2 = shared_2(x_2)
        x_3 = shared_2(x_3)
        ...
        shared_5 = SeparableConv2D(728, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv2')
        x_1 = shared_5(x_1)
        x_2 = shared_5(x_2)
        x_3 = shared_5(x_3)
        ...
        shared_8 = SeparableConv2D(728, (3, 3), padding='same', use_bias=False, name=prefix + '_sepconv3')
        x_1 = shared_8(x_1)
        x_2 = shared_8(x_2)
        x_3 = shared_8(x_3)
    ...
    block13_sepconv1 = SeparableConv2D(728, (3, 3), padding='same', use_bias=False, name='block13_sepconv1')
    ...
    block13_sepconv2 = SeparableConv2D(1024, (3, 3), padding='same', use_bias=False, name='block13_sepconv2')
    block13_sepconv2_bn = BatchNormalization(name='block13_sepconv2_bn')
    block13_pool = MaxPooling2D((3, 3), strides=(2, 2), padding='same', name='block13_pool')
    ...
    block14_sepconv1 = SeparableConv2D(1536, (3, 3), padding='same', use_bias=False, name='block14_sepconv1')
    ...
    block14_sepconv2 = SeparableConv2D(2048, (3, 3), padding='same', use_bias=False, name='block14_sepconv2')
