...
parser.add_argument(
    '--checkpoint-path',
    default='checkpoint/motion_temporal/weights.{epoch:02d}-{val_acc:.4f}.hdf5',
    type=str,
    metavar='PATH',
...
def train():
    ...
    validation_video_poses = VideosPoses(
    ...
    model.fit_generator(
        generator=train_video_poses,
        epochs=args.epochs,
        callbacks=callbacks,
        validation_data=validation_video_poses,
