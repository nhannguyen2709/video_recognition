...
ucf101 = pickle.load(open('dataloader/dic/ucf101_frame_count.pickle', mode='rb'))
merged = pickle.load(open('dataloader/dic/merged_frame_count.pickle', mode='rb'))


valid_video_names = sorted(os.listdir('data/NewVideos/validation_videos/'))
valid_video_paths = [os.path.join('data/NewVideos/validation_videos/', video_name) for video_name in valid_video_names]
valid_video_frame_counts = [len(sorted(os.listdir(video_path))) for video_path in valid_video_paths]
